...
public class OLDGathererController : MonoBehaviour
{
    ...
    private ResourceNode m_depletedNode;
    ...
    private void SetResourceNode()
    {
        ...
        Collider depletedNodeCollider = m_depletedNode.GetComponent<Collider>();
        List<ResourceNode> nearbyNodes = new List<ResourceNode>();

        //Get a bunch of nodes near the point.
        Collider[] colliders = Physics.OverlapSphere(m_depletedNode.transform.position, detectionRadius, layerMask);
